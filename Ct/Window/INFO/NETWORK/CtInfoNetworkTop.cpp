 ...
 *  Element: CtInfoNetworkTop
 */
#include "CtInfoNetworkTop.h"
#include "CtLabel.h"
#include "CtWindow.h"

CtInfoNetworkTop::CtInfoNetworkTop() :
    m_pBox(NULL),
...
CtLayout* CtInfoNetworkTop::createContainer()
{
...
bool CtInfoNetworkTop::destroyContainer()
{
    if(NULL == m_pBox){
        delete m_pBox;
    }
...
bool CtInfoNetworkTop::handleButtonEvent(const CtEventButton& Event)
{
...
CtButton* CtInfoNetworkTop::getTouchButton(CtPosition Pos){
