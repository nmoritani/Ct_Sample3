 ...
 *  Element: CtInfoSwitchesBottom
 */
#include "CtInfoSwitchesBottom.h"
#include "CtLabel.h"
#include "CtWindow.h"

CtInfoSwitchesBottom::CtInfoSwitchesBottom() :
    m_pBox(NULL),
...
CtLayout* CtInfoSwitchesBottom::createContainer()
{
...
bool CtInfoSwitchesBottom::destroyContainer()
{
    if (m_pBox)
    {
        delete m_pBox;
...
bool CtInfoSwitchesBottom::handleButtonEvent(const CtEventButton& Event)
{
...
CtButton* CtInfoSwitchesBottom::getTouchButton(CtPosition Pos){
