 ...
 *  Element: CtInfoVersionBottom
 */
#include "CtInfoVersionBottom.h"
#include "CtLabel.h"
#include "CtWindow.h"

CtInfoVersionBottom::CtInfoVersionBottom() :
    m_pBox(NULL),
...
CtLayout* CtInfoVersionBottom::createContainer()
{
...
bool CtInfoVersionBottom::destroyContainer()
{
    if (m_pBox)
    {
        delete m_pBox;
...
bool CtInfoVersionBottom::handleButtonEvent(const CtEventButton& Event)
{
...
CtButton* CtInfoVersionBottom::getTouchButton(CtPosition Pos){
