...
/*                                                                        */ 
/*  10-10-2009     William E. Lamie         Initial Cortex-A9/RealView    */ 
/*                                            Support Version 5.0         */ 
...
#define TX_DISABLE                              interrupt_save_disabled =  __disable_irq(); \
                                                __disable_fiq();
...
CHAR                            _tx_version_id[] = 
                                    "ThreadX Cortex-A9/RVDS Version G5.5.5.2 / v1.0rel1.4";
#else
