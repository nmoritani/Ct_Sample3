#ifndef __CtWindowContentsMessage_H__
#define __CtWindowContentsMessage_H__

#include "CtWindowContents.h"
#include "CtMessageDesign.h"
#include "str_id.h"

class CtWindowContentsMessage : public CtWindowContents {
public :
	...
	CtWindowContentsMessage(const CtWindowID WindowID);
	CtWindowContentsMessage(CtWindowContentsMessage& message);
	virtual ~CtWindowContentsMessage();
