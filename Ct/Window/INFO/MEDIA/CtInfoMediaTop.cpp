 ...
 *  Element: CtInfoMediaTop
 */
#include "CtInfoMediaTop.h"
#include "CtLabel.h"
#include "CtWindow.h"

CtInfoMediaTop::CtInfoMediaTop() :
    m_pBox(NULL),
...
CtLayout* CtInfoMediaTop::createContainer()
{
...
bool CtInfoMediaTop::destroyContainer()
{
    if (m_pBox)
    {
        delete m_pBox;
...
bool CtInfoMediaTop::handleButtonEvent(const CtEventButton& Event)
{
...
CtButton* CtInfoMediaTop::getTouchButton(CtPosition Pos){
